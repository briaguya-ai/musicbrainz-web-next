    ...
    <>
      <Head>
        ...
        <link
          ...
          sizes="180x180"
          href="%PUBLIC_URL%/assets/favicons/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
        ...
        <link
          rel="manifest"
          href="%PUBLIC_URL%/assets/favicons/site.webmanifest"
        />
        <link
          rel="mask-icon"
          href="%PUBLIC_URL%/assets/favicons/safari-pinned-tab.svg"
          color="#5bbad5"
        />
        <link
          rel="stylesheet"
