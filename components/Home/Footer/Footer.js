        ...
        <div className="row">
          <div className="col-sm-12 col-md-4">
            <h3 className="navbar-brand text-brand">
              <img
                src="assets/img/meb-icons/MusicBrainz.svg"
                width="52"
                alt="image"
              />{' '}
            ...
            <p className="color-gray">
              is an open music encyclopedia that collects music metadata and
          ...
          <div className="col-sm-12 col-md-3 section-md-t3">
            ...
            <ul className="list-unstyled">
              <li className="item-list-a">
                <i className="bi bi-chevron-right" />{' '}
                <img
                  src="assets/img/meb-icons/ListenBrainz.svg"
                  width="24"
                  height="24"
                  alt="image"
                />{' '}
              ...
              <li className="item-list-a">
                <i className="bi bi-chevron-right" />{' '}
                <img
                  src="assets/img/meb-icons/CritiqueBrainz.svg"
                  width="24"
                  height="24"
                  alt="image"
                />{' '}
              ...
              <li className="item-list-a">
                <i className="bi bi-chevron-right" />{' '}
                <img
                  src="assets/img/meb-icons/Picard.svg"
                  width="24"
                  height="24"
                  alt="image"
                />{' '}
              ...
              <li className="item-list-a">
                <i className="bi bi-chevron-right" />{' '}
                <img
                  src="assets/img/meb-icons/BookBrainz.svg"
                  width="24"
                  height="24"
                  alt="image"
                />{' '}
              ...
              <li className="item-list-a">
                <i className="bi bi-chevron-right" />{' '}
                <img
                  src="assets/img/meb-icons/AcousticBrainz.svg"
                  width="24"
                  height="24"
                  alt="image"
                />{' '}
              ...
              <li className="item-list-a">
                <i className="bi bi-chevron-right" />{' '}
                <img
                  src="assets/img/meb-icons/CoverArtArchive.svg"
                  width="24"
                  height="24"
                  alt="image"
                />{' '}
        ...
        <div className="row center-p">
          ...
          <div className="col-md-6">
            <p className="section-line">
              Brought to you by{' '}
              <img
                src="assets/img/meb-icons/MetaBrainz.svg"
                width="30"
                height="30"
                alt="image"
              />{' '}
