      ...
      <div className="container" data-aos="fade-up">
        ...
        >
          ...
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img
                src="assets/img/supporters/microsoft.png"
                className="img-thumbnail"
                alt=""
              />
            </div>
          ...
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img
                src="assets/img/supporters/pandora.png"
                className="img-thumbnail"
                alt=""
              />
            </div>
          ...
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img
                src="assets/img/supporters/hubbard.png"
                className="img-thumbnail"
                alt=""
              />
            </div>
          ...
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img
                src="assets/img/supporters/Amazon_logo.svg"
                className="img-thumbnail"
                alt=""
              />
            </div>
          ...
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img
                src="assets/img/supporters/siriusxm.jpg"
                className="img-thumbnail"
                alt=""
              />
            </div>
