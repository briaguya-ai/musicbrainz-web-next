        ...
        <div className="row">
          ...
          >
            <h3 className="navbar-brand text-brand">
              About <span className="color-purple">Music</span>
              <span className="color-orange">Brainz</span>
            </h3>
            <p className="fst-italic">
              MusicBrainz is an open music encyclopedia that collects music
              metadata and makes it available to the public.
              <br />
              <br />
            ...
            <ul>
              <li>
                ...
                contribute and releasing the data under open licenses.
              </li>
              <li>
                <i className="bi bi-check-circle" />
                The universal lingua franca for music by providing a reliable
                and unambiguous form of music identification, enabling both
                people and machines to have meaningful conversations about
                music.
              </li>
              <li>
                <i className="bi bi-check-circle" />
                Like Wikipedia, MusicBrainz is maintained by a global community
                of users and we want everyone — including you — to participate
                and contribute.
              </li>
            </ul>
            <a
