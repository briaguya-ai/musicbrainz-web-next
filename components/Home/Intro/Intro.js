...
class Intro extends React.Component {
  ...
  render() {
    ...
    return (
      <section
        id="intro"
        className={'intro d-flex align-items-center ' + theme}
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-9 d-flex flex-column justify-content-center">
              ...
              >
                {this.state.posts ? (
                  this.state.posts.map((artwork, indx) => {
                    return (
              ...
              <div className="card">
                ...
                <ul className="list-group list-group-flush">
                  <li className={'list-group-item'}>
                    <a
                      href="https://blog.metabrainz.org/2021/10/07/picard-2-7-beta-1/"
                      target="_blank"
                  ...
                  <li className={'list-group-item'}>
                    <a
                      href="https://blog.metabrainz.org/2021/10/06/picard-2-6-4-released/"
                      className="card-link"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <li className={'list-group-item'}>
                    <a
                      href="https://blog.metabrainz.org/2021/10/04/musicbrainz-server-update-2021-10-04/"
                      className="card-link"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <li className={'list-group-item'}>
                    <a
                      href="https://blog.metabrainz.org/2021/09/20/musicbrainz-server-update-2021-09-20/"
                      className="card-link"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <li className={'list-group-item'}>
                    <a
                      href="https://blog.metabrainz.org/2021/09/06/musicbrainz-server-update-2021-09-06/"
                      className="card-link"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <li className={'list-group-item'}>
                    <a
                      href="https://blog.metabrainz.org/2021/09/01/acoustic-similarity-in-acousticbrainz/"
                      className="card-link"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <li className={'list-group-item'}>
                    <a
                      href="https://blog.metabrainz.org/2021/08/23/gsoc-2021-pin-recordings-and-critiquebrainz-integration-in-listenbrainz/"
                      className="card-link"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      GSoC 2021: Pin Recordings and CritiqueBrainz Integration
                      in ListenBrainz
                    </a>
                  </li>
                </ul>
